    ...
    return isLoading ? (
        ...
        <div className="mt-4">
            <div className="flex items-center justify-between">
                <span className="text-sm tracking-wide">Ongoing Sheets</span>
            ...
            <div className="mt-2 flex flex-col gap-1">
                {ongoingSheets.map((sheet, idx) => {
                    const { completionCount, problemCount, completionRatio } = getSheetDetails(sheet);
                    return <Link
                        to={"/sheets/" + sheet.id}
                        ...
                        <div className="relative">
                            <CircularProgress percentage={completionRatio * 100} radius={15} stroke={2} />
